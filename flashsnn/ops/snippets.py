...
def convert_and_store(pointer, value, boundary_check):
    ...
    However, we suggest passing dtypes as constexpr arguments to the kernels 
    rather than using this wrapper. In this way, Triton will compile multiple 
    versions of the kernel for different dtypes and skip unnecessary type
    conversions!
    """
